...
public class Parameter {
	...
	private int progressType = TokenTypes.VARIABLE;
	...
	public JPNode getDirectionNode() {return directionNode;}

	/** Integer corresponding to TokenType for (BUFFER|VARIABLE|TEMPTABLE|DATASET|PARAMETER).
	 * The syntax <code>PARAMETER field = expression</code> is for RUN STORED PROCEDURE, and
	 ...
	 * For Routines, the symbol should always be non-null.
	 */
