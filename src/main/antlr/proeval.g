/*
proeval.g - Tree walker for evaluating Progress code chunks

Used when we hit an &IF <expr>. Returns bool, depending on how <expr> evaluates out.

Copyright (C) 2001-2009 Joanju Software (www.joanju.com). All rights reserved.
This file is made available under the terms of the Eclipse Public License v1.0.
*/


///// Antlr settings and options
